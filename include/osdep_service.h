...
static inline void _enter_critical(_lock *plock, unsigned long *pirqL)
{
	spin_lock_irqsave(plock, *pirqL);
}

static inline void _exit_critical(_lock *plock, unsigned long *pirqL)
{
	spin_unlock_irqrestore(plock, *pirqL);
}

static inline void _enter_critical_ex(_lock *plock, unsigned long *pirqL)
{
	spin_lock_irqsave(plock, *pirqL);
}

static inline void _exit_critical_ex(_lock *plock, unsigned long *pirqL)
{
	spin_unlock_irqrestore(plock, *pirqL);
}

static inline void _enter_critical_bh(_lock *plock, unsigned long *pirqL)
{
	spin_lock_bh(plock);
}

static inline void _exit_critical_bh(_lock *plock, unsigned long *pirqL)
{
