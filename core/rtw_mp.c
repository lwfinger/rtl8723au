	...
	)
{
	...
	DBG_8723A("_rtw_mp_xmit_priv reinit for normal mode\n");
...
//	desc->txdw3 |= cpu_to_le32((pattrib->seqnum & 0xFFF) << SEQ_SHT);
	...
	if (IS_ERR(pmp_priv->tx.PktTxThread))
		DBG_8723A("Create PktTx Thread Fail !!!!!\n");
#endif
#ifdef PLATFORM_FREEBSD
{
	struct proc *p;
...
void Hal_ProSetCrystalCap (PADAPTER pAdapter , u32 CrystalCapVal)
{
	...
	{
		DBG_8723A(" not as 88E and 92D Hal_ProSetCrystalCap 0x2c !!!!!\n");
