...
static void _mgt_dispatcher(struct rtw_adapter *padapter, struct mlme_handler *ptable, struct recv_frame *precv_frame)
{
...
void mgt_dispatcher(struct rtw_adapter *padapter, struct recv_frame *precv_frame)
{
	int index;
